...
export default function PortalPage() {
  ...
  // 🧠 Unlock logic
  const phaseLocked = [
    !hasPaid, // Phase 1 locked if user hasn't paid
    !hasPaid || courseProgressPhase1 < 100, // Phase 2 locked until Phase 1 done
    !hasPaid || courseProgressPhase2 < 100, // Phase 3 locked until Phase 2 done
  ];
