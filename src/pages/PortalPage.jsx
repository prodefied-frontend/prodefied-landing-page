...
/**
 * PhaseCard Component (small card used in the "My Learning" list)
 */
 ...
 * - always shows "Accepted" for application status unless the user is graduated
 */
export default function PortalPage() {
  ...
  // derive graduated flag (UI only)
  const isGraduated = !!(user?.isGraduated || user?.is_graduated || false);

  // Application Status - UI only
  // If graduated -> Graduated; otherwise always show Accepted per your flow rules
  let applicationStatus = "Accepted";
  let statusBg = "#E0FAE3"; // green-ish for accepted
  let statusIcon = "/green-mark.svg";
  let statusTextColor = "#15480C";
