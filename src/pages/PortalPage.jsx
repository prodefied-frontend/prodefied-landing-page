...
//   // Split phase title (assumes format "Phase N Word")
//   const [phaseWord, ...rest] = phase.phaseTitle.split(" ").slice(2);
//   const phasePrefix = phase.phaseTitle.split(" ").slice(0, 2).join(" ");

//   return (
//     <div
//       className="bg-white border border-[#E6E6E6] p-4 rounded-md transition-transform hover:scale-[1.01] hover:shadow-md duration-300"
//       aria-expanded={isOpen}
//     >
//       {/* Header */}
//       <div className="flex justify-between items-start space-x-2">
...
//       {/* Start Assessment Button (always visible, full width) */}
//       <a
//         href={phase.assessmentLink}
//         target="_blank"
//         rel="noopener noreferrer"
...
//             target="_blank"
//             rel="noopener noreferrer"
//             className="inline-flex items-center gap-2 bg-[#FF9D00] text-white text-sm py-2 px-4 rounded-md hover:bg-[#c67a00]"
//           >
//             Start Learning
