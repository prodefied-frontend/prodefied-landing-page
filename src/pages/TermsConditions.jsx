...
// import termsConditions from "../assets/images/terms-condition.jpg"
...
//       />
//       <h3 className="hidden md:block text-3xl md:text-4xl mb-6 font-semibold">
//         Privacy Policy
//       </h3>
//       <p className="text-[#4D4D4D] text-sm md:text-lg mb-4 md:mb-8">
//         e collect personal information such as email, CV, and LinkedIn profiles
...
//       </h3>
//       <ul className="text-[#4D4D4D] text-sm md:text-lg mb-4 md:mb-8">
//         <li>
//           Program Participation: By enrolling in Prodefied, you agree to
//           actively participate in all program activities and complete assigned
//           tasks.
//         </li>
//         <li>
...
//         </li>
//         <li>
//           Code of Conduct: Participants are expected to maintain professionalism
//           and respect towards mentors and peers.
//         </li>
//         <li>
//           Intellectual Property: All materials provided during the program are
//           the property of Prodefied and are for personal use only.
//         </li>
//       </ul>
//       <h3 className="hidden md:block text-3xl md:text-4xl mb-6 font-semibold">
//         Cookie Policy
...
// }
import React from "react";
import termsConditionsImg from "../assets/images/terms-condition.jpg";

const SectionHeading = ({ children }) => (
  <h3 className="hidden md:block text-xl md:text-2xl mb-3 text-[#4D4D4D]">
    {children}
  </h3>
);
