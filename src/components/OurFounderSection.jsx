      ...
      <div className="flex flex-col md:flex-row md:gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex-1 mt-6 md:mt-0 space-y-4 text-[#4D4D4D] text-sm md:text-base">
          <p>
            ...
            into tech. Like many Product Managers or those aspiring to become
            one, she came from a non-traditional background. She dabbled in
            copywriting, digital marketing, content writing, affiliate
            marketing... you name it.
            <span className="text-[#000F84] cursor-pointer block md:hidden">Read More</span>
          </p>
...
//     return (
//         <section>
//             <h2 className='text-center text-lg md:text-4xl'>What drives our Founder?</h2>

//             <div className='flex flex-col md:flex-row'>
//                 <div>
//                     <img src={PeaceAvatar} alt="Peace Avatar Image" />
...
//                 <div>
//                     <p>
//                         Peace Agoha is a Product Manager who didn't take “typical” path into tech. Like many Product Managers or those aspiring to become one, she came from a non-traditional background. She dabbled in copywriting, digital marketing, content writing, affiliate marketing... you name it.
//                     </p>
//                     <p>
//                         She experienced confusion, the rejections, the imposter syndrome, and the lack of structure that makes one break into product management feeling overwhelming.
//                         <span>Read More</span>
//                     </p>
//                 </div>
...
//                     <div className='flex'>
//                         {teamDetailsOne.map((person) => (
//                             <div key={person.id} className='flex flex-col items-center justify-center'>
//                                 <img src={person.image} alt="Avatar images of the team leads" className='w-16 h-16' />
...
//                         <div>
//                             {teamImages.map((image, index) => (
//                                 <img key={index + 1} src={image} alt="avatar images of the team members" />
//                             ))}
//                         </div>
//                         <img src="/logo-blue.svg" alt="Logo Icon" className='w-12 h-12' />
