...
// export default function WhatMakesUsDifferent() {
//   return (
//     <section className="px-12 py-14 bg-[#F5F2F2]">
//       <h2 className="text-xl md:text-4xl font-semibold text-center">
//         What makes us{" "}
//         <span className=" text-[#FFB236] relative">
//           different <img src={VectorForDifferent} alt="" className="absolute -bottom-2 left-0" />
//         </span>
//       </h2>
...
//           <div
//             key={cDetail.id}
//             className="border-[#001196] border-[1px] flex flex-col items-center justify-center gap-4 p-4 bg-white"
//           >
//             <img src={cDetail.icon} alt={cDetail.title} />
//             <h3 className="text-[#333333]">{cDetail.title}</h3>
//             <p className="text-center text-[#706E6E]">{cDetail.description}</p>
//           </div>
//         ))}
//       </div>
//     </section>
