...
const WhatMakesUsUniqueSection = forwardRef(function WhatMakesUsUniqueSection(
  _props,
  ref
) {
  return (
    <section ref={ref} className="py-4 px-8 space-y-10">
      {" "}
      {/* Header */}{" "}
      <div>
        {" "}
      ...
      <a
        ...
        className=" text-[#0929FF] text-base md:text-2xl"
      >
        {" "}
