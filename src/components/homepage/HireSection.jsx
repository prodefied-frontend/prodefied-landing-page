  ...
  return (
    <section className="bg-[#E5E8FF] py-12 px-8 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        {/* Mobile Heading */}
        <h2 className="text-lg text-center md:hidden font-semibold">Hire Our Talents</h2>
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:gap-12">
          ...
          <div className="text-center md:text-left md:w-[50%]">
            <h3 className="hidden md:block text-3xl md:text-4xl mb-6 font-semibold">Hire Our Talents</h3>
