    ...
    <nav className="fixed top-0 left-0 w-full bg-white z-50 shadow px-4 py-6 md:px-8 text-[#000000]">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex justify-end flex-shrink-0">
          <Link
            to="/sign-up"
            className="bg-[#000F84] text-white text-sm lg:text-base py-3 px-6 rounded-lg hover:bg-[#0018a8] transition"
          >
            Apply Now
          </Link>
        </div>
      ...
      <div
        className={`md:hidden fixed top-0 right-0 w-full min-h-screen bg-[#0929FF] text-white z-50 transition-transform duration-500 ease-in-out ${
        ...
        <div className="flex flex-col justify-center min-h-[calc(90vh-72px)] py-12 px-6">
          ...
          <div className="flex justify-center mt-10">
            <Link
              to="/sign-up"
              onClick={() => setMenuOpen(false)}
              className="bg-white text-[#0929FF] text-sm py-2 px-6 rounded-xl hover:bg-[#f0f4ff] transition"
            >
              Apply Now
            </Link>
          </div>
