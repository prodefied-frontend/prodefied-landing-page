...
export default function HeroSection() {
  return (
    <main className="bg-white md:mt-6">
      <div className="flex flex-col items-center gap-4 px-8 md:px-20 md:flex-row md:justify-between">
      ...
      <div className="py-8 px-8 md:px-20 flex flex-col md:flex-row gap-6 md:justify-between md:items-center ">
        ...
        <div className="flex items-center justify-center gap-4 md:gap-16">
          <div className="flex flex-col items-center gap-2 md:gap-4 border-[1px] border-[#B3B3B3] p-2 py-4 rounded-sm">
            <img
              src={BookmarkIcon}
              alt="Call Icon"
              className="w-14 h-14 md:w-20 md:h-20"
            />
            <span className="text-xs md:text-base text-white bg-[#FF9D00] border-[1px] border-[#FF9D00] px-4 py-2  md:px-8 md:py-4 rounded-md">
              Product Guide Book
            </span>
          </div>
